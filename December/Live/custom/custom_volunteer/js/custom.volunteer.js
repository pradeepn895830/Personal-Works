(function($){
   Drupal.behaviors.custom_volunteer = {
     attach: function (context) {
	   ...
	   //Change Error message for Terms & Conditions
	   var lang = Drupal.settings.customvolunteer.language;
	   if(lang == 'en')
	      $('div[id^=edit-field-terms-comdition]', context).find('div.messages-inline').html('Please accept the terms and conditions');
	 }
    };   
})(jQuery);