	...
	<div class="issue-raise-wrapper">
	   ...
	   <?php if(user_is_anonymous()):?>
	      <?php 
	        ...
	        $options = array('attributes' => array('class' => $classes, 'rel' => 'nofollow', 'id' => 'raise-an-issue'), 'query' => array('destination'=>'raise-issue'));
		  ?>
		    <span class="signup-button"><?php print l(t('Raise an Issue'), 'ajax_register/register/nojs', $options); ?></span>
	   <?php else: ?>
	        <?php $options = array('attributes' => array('id' => 'raise-an-issue'), 'query' => array('destination' => current_path())); ?>
