...
<span class="<?php print $flag_wrapper_classes; ?>">
  <?php if ($link_href): ?>
    <a id="cpage-signup" href="<?php print $link_href; ?>" title="<?php print $link_title; ?>" class="<?php print $flag_classes ?>" rel="nofollow"><?php print $link_text; ?></a>
    <span class="numFollowers">
	<?php 
	$counts = flag_get_counts('taxonomy_term', arg(2) );
	
	if(isset($counts['follow_constituency']))
	{
		$followercount = $counts['follow_constituency'];
		print $followercount;
